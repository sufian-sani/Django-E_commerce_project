...
def payment(request):
    ...
    store_id = 'abc619956ac860d2'
    API_key = 'abc619956ac860d2@ssl'
    ...
    mypayment.set_product_integration(total_amount=Decimal(order_total), currency='BDT', product_category='Mixed', product_name=order_item, num_of_item=order_items_count, shipping_method='Courier', product_profile='None')
...
def complete(request):
    if request.method == 'POST' or request.method == 'post':
        ...
        # bank_tran_id = payment_date['bank_tran_id']
        ...
        if status == 'VALID':
            ...
            messages.success(request,f"Your Payment Failed! Please Try Again! Page will be redirected!")
